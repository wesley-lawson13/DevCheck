...
export default function ProjectDetail() {
  ...
  const projectCreated = location.state?.message;
  ...
  return (
    <div>
      ...
      {successMessage && (
        <div className="flex justify-between w-full bg-green/60 border border-green text-white px-4 py-3 rounded mb-5">
          {successMessage}
          <button className="text-muted" onClick={() => setSuccessMessage("")}>
            &times;
          </button>
        </div>
      )}
      ...
      <div
        className={`min-h-screen p-4 transition-all duration-200 ${
          showDeleteModal || showUpdateStatusModal
                        ...
                        addingTask[key] && (
                          <li className="flex items-center gap-2 mt-2">
                            ...
                            <button
                              ...
                              onClick={() =>
                                handleCancelAdd(page.id, "MVP", section?.id)
                              }
                            >
                              ✕
                            </button>
                        ...
                        addingTask[key] && (
                          <li className="flex items-center gap-2 mt-2">
                            ...
                            <button
                              className="text-red-500 font-bold"
                              onClick={() =>
                                handleCancelAdd(page.id, "DEV", section?.id)
                              }
                            >
                              ✕
                            </button>
                        ...
                        addingTask[key] && (
                          <li className="flex items-center gap-2 mt-2">
                            ...
                            <button
                              className="text-red-500 font-bold"
                              onClick={() =>
                                handleCancelAdd(page.id, "DEPLOY", section?.id)
                              }
                            >
                              ✕
                            </button>
          ...
          <div className="p-6 bg-dark rounded-xl shadow-2xl w-80 border border-gray-200">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                onClick={async () => deletePage(pageToDelete)}
              >
                Delete
              </button>
            </div>
      ...
      {showUpdateStatusModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-opacity-30">
          <div className="p-6 bg-dark rounded-xl shadow-2xl w-80 border border-gray-200">
            ...
            <p className="text-green mb-6">
              Switch project status to{" "}
              <strong className="text-green">{statusToSet}</strong>?
            </p>
