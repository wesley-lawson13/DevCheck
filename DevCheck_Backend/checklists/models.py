...
class Project(models.Model):
    ...
    image = models.ImageField(blank=True, null=True, upload_to='projects/', default='https://res.cloudinary.com/dpodsvx94/image/upload/v1769448461/copyLogo_tni1wh.png')
